...
namespace GAPPLE.Server.Controllers
{
	...
	public class SeguridadController : ControllerBase
	{
		...
		{
			DA_Seguridad daP = new(Configuration.GetConnectionString("DefaultConnection"));
			daP.PostUsuarioPerfiles(perfil.DescripcionPerfil);
			return Ok();
		}
		[HttpPut("perfiles")]
		...
		{
			DA_Seguridad daP = new(Configuration.GetConnectionString("DefaultConnection"));
			daP.PutUsuarioPerfiles(perfil.IdPerfil,perfil.DescripcionPerfil);
			return Ok();
		}
